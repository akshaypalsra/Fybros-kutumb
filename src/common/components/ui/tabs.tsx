    ...
    return (
        <TabsPrimitive.Trigger
            ...
            className={cn(
                ...
                "group-data-[variant=line]/tabs-list:after:h-[1px]",
                ...
                "group-data-[variant=line]/tabs-list:data-[state=active]:after:scale-x-90",
                "data-[state=active]:bg-card data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-card/70 dark:data-[state=active]:text-foreground",
