...
export const FinanceHeader = ({
  ...
  <div className="mb-6 flex items-center justify-between">
    <div className="flex items-center gap-3">
      <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#E92739]/10 text-lg font-bold text-[#E92739]">
        {partnerName?.[0] ?? "A"}
      </div>
      <div>
    ...
    <div className="flex items-center gap-6">
      ...
      >
        ...
        <span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-[#E92739]" />
      </button>
    </div>
  </div>
)