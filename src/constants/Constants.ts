...
export const CONSTANTS = {
  ...
  SSO_DESKTOP_CLIENT_ID: import.meta.env.VITE_SSO_DESKTOP_CLIENT_ID,
  TAURI_SSO_DEVICE_LOGIN_URL: import.meta.env.VITE_TAURI_SSO_DEVICE_LOGIN_URL,
  TAURI_SSO_TOKEN_URL: import.meta.env.VITE_TAURI_SSO_TOKEN_URL,
